...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """It performs integration tests
    """
    @classmethod
    def setUpClass(cls) -> None:
        """It seets up class fixtures before running tests.
        """
        route_payload = {
    ...
    def test_public_repos(self) -> None:
        """ This is tests for public_repos method.
        """
        self.assertEqual(
            GithubOrgClient("google").public_repos(),
            self.expected_repos,
    ...
    def test_public_repos_with_license(self) -> None:
        """It tests the public_repos method with a license.
        """
        self.assertEqual(
